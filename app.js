  ...
  function buildGuideSections(){
    return [
      ...
      },
      {
        ...
        body: 'يوجد قسم تنزيلات داخل الإعدادات يشير إلى ملف APK للتثبيت المباشر على Android. يمكن تثبيت التطبيق كـ PWA من المتصفح أيضًا.',
        steps: [
...
let pinOnly = false;
  function renderDownloads(){
    ...
    if (overview){
      ...
      const APK_LATEST_URL = `${DOWNLOADS_URL}ai-workspace-studio-latest.apk?v=${Date.now()}`;
        ...
        <div class="bubble app-dl-card" style="margin:0;padding:16px">
          <div style="display:flex;align-items:center;gap:12px;margin-bottom:14px">
            ...
            <div style="flex:1;min-width:0">
              ...
              <div class="hint" id="releaseVersionMeta" style="margin-top:2px">النسخة التجريبية الأحدث للأندرويد — جاهزة للتثبيت المباشر.</div>
            </div>
          ...
          <div class="actions" style="flex-wrap:wrap;gap:8px">
            ...
            <a class="btn ghost sm" href="${WEB_URL}" target="_blank" rel="noopener noreferrer">🌐 فتح نسخة الويب</a>
          </div>
          <div class="hint" style="margin-top:10px;font-size:.78em">
            Android 7.0+ • فعّل «السماح بالتثبيت من مصادر غير معروفة» في إعدادات الأمان قبل التثبيت.
          </div>
        </div>`;
    }
